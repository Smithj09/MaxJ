  ...
  const items = [
    {
      ...
      image: "https://i.postimg.cc/Qdz2z32H/5feee138-0e1b-48fd-8d89-c115fb7e42f3.jpg",
      icon: (
    ...
    },
    {
      ...
      image: "https://i.postimg.cc/GpN7Z8kD/Whats-App-Image-2026-01-29-at-09-58-28.jpg",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
