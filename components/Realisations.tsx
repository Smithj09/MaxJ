            ...
            {items.map((item, idx) => (
              <div key={idx} className="group p-6 sm:p-8 bg-slate-50 rounded-3xl border border-slate-100 hover:bg-white hover:shadow-xl hover:border-transparent transition-all duration-300">
                <div className="flex justify-between items-start mb-6">
                  <div className="p-2.5 bg-white rounded-xl text-blue-600 shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    <div className="scale-90 sm:scale-100">{item.icon}</div>
                  </div>
                  <span className="text-xl sm:text-2xl font-black text-slate-200 group-hover:text-red-100 transition-colors">
                    {item.year}
                  </span>
                </div>
