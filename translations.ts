...
export const translations: Record<Language, any> = {
  fr: {
    ...
    contact: { title: 'Me Contacter', firstName: 'Prénom', lastName: 'Nom', email: 'Email', message: 'Message', submit: 'Envoyer', success: 'Message envoyé avec succès!', error: 'Erreur lors de l\'envoi du message. Veuillez réessayer.' }
  },
  en: {
    ...
    contact: { title: 'Contact Me', firstName: 'First Name', lastName: 'Last Name', email: 'Email', message: 'Message', submit: 'Send', success: 'Message sent successfully!', error: 'Error sending message. Please try again.' }
  },
  ru: {
    ...
    contact: { title: 'Связаться со мной', firstName: 'Имя', lastName: 'Фамилия', email: 'Email', message: 'Сообщение', submit: 'Отправить', success: 'Сообщение успешно отправлено!', error: 'Ошибка при отправке сообщения. Пожалуйста, попробуйте еще раз.' }
  },
  zh: {
    ...
    contact: { title: '联系我', firstName: '名字', lastName: '姓氏', email: '邮箱', message: '消息', submit: '发送', success: '消息发送成功！', error: '发送消息时出错。请重试。' }
  }
};